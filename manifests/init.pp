...
class tomcat(
  ...
  $java_opts_xms               = $::tomcat::params::java_opts_xms,
  $java_opts_xmx               = $::tomcat::params::java_opts_xmx,
  $java_opts_maxpermsize       = $::tomcat::params::java_opts_maxpermsize,
  $java_opts_system_properties = $::tomcat::params::java_opts_system_properties,
